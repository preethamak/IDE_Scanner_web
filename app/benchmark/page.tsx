...
const cohort = [
  ["10", "hash-pinned artifacts scanned"], ["50", "target evaluation cohort"], ["100%", "coverage in the current 10-artifact regression run"], ["0", "public efficacy rates claimed"],
];
const protocol = [
