...
function Explore() {
  ...
  return <main className="catalogPage pageWrap">
    <section className="catalogHero exploreHero"><span className="kicker">Explore extensions</span><h1>Find the extension.<br/>Read the evidence.</h1><p>Search published IDE extensions across supported registries. Identity, release history, and artifact evidence stay separate so metadata never masquerades as analysis.</p><ExtensionSearch initialQuery={query} submitLabel="Explore extensions"/><div className="catalogPromises"><span>Exact-version dossiers</span><span>Published icon or branded fallback</span><span>Public without sign-in</span></div></section>
