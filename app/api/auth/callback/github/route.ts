...
export async function GET(request: Request) {
  ...
  try {
    ...
    response.headers.append("Set-Cookie", `gr_oauth_state=; Max-Age=0; Path=/; HttpOnly;${secure ? " Secure;" : ""} SameSite=Lax`);
    response.headers.append("Set-Cookie", `gr_oauth_next=; Max-Age=0; Path=/; HttpOnly;${secure ? " Secure;" : ""} SameSite=Lax`);
    return response;
  } catch {
