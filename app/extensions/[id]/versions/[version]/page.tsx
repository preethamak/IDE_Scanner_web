...
export default async function VersionPage({ params }: { params: Promise<{ id: string; version: string }> }) {
  ...
  return <PublicSecuritySummary extension={extensionProduct.extension} version={version} versions={extensionProduct.versions} scan={scan || null} fullAnalysisHref={fullAnalysisHref}/>;
}
