...
export const PUBLIC_OUTCOMES: Record<PublicOutcome, { label: string; short: string; explanation: string; tone: "allow" | "review" | "block" | "incomplete" }> = {
  ...
  explained_preventive_chain: { label: "Review · explained update chain", short: "Review · explained", explanation: "Download-and-install behavior matches the verified publisher's documented purpose; held for human confirmation instead of blocking.", tone: "review" },
